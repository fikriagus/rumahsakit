...
<div class="box">
  ...
  <h4>
    ...
    <div class="pull-right">
      ...
      <a href="generate.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-push"></i>Tambah Poli</a>
    </div>
  </h4>
    ...
    <table class="table table-striped table-bordered tabel-hover">
      ...
      <tbody>
        ...
        if(mysqli_num_rows($sql_poli)> 0){
          ...
          echo"<tr><td colspan=\"4\" align=\"center\">Data Tidak Ditemukan</tr></td> ";
        }
        ?>
      </tbody>
    </table>
